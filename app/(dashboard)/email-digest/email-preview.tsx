  ...
  return (
    <div className="p-container-margin">
      ...
      <div className="mx-auto max-w-[600px] card overflow-hidden">
        {/* Header */}
        <header className="p-8 border-b border-border bg-surface-card">
        ...
        {/* Metrics */}
        <section className="p-8 bg-surface-elevated">
        ...
        {/* Footer */}
        <footer className="p-8 border-t border-border bg-surface-elevated text-center">
